...
describe() is optional, this makes the tests organized adn the code more clear and readable.
it() is a method that runs the actual unit test.
 
2. What is the point of `Test Driven Development`? What do you think about this approach?

TDD prevents bugs on the initial stage so you have less bugs to fix later!
TDD is worth it, it takes longer but will help in the later stages.
